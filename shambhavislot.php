...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
        <form action="availshambhavi.php" style="border:1px solid rgb(0, 0, 0)" method="post" class="form">
          <a href="sowparnika.php" class="close">&times;</a>
          ...
          $_SESSION['ename']=$ename;
             ...
             $sql="select s.start,s.end from slots s where s.start>=ALL(select b.end from booking b where b.venueid='NMV3' and b.edate='$date')and s.end>ALL(select b.start from booking b where b.venueid='NMV3' and b.edate='$date') and s.venueid='NMV3';";
