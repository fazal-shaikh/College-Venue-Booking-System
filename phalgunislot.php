...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
        <form action="availphalguni.php" style="border:1px solid rgb(0, 0, 0)" method="post" class="form">
          <a href="phalguni.php" class="close">&times;</a>
          ...
          $sql="select start,end from slots s where s.start not in(select b.end from booking b where b.venueid='NMV5' and b.edate='$date') and s.end>ALL(select b.end from booking b where b.venueid='NMV5' and b.edate='$date') and s.venueid='NMV5';";
