...
if(isset($_POST['approve'])){
    ...
    $stmt = $con->prepare("UPDATE booking SET inchargeApproval='approved' WHERE venueid=? AND edate=? AND start=? AND end=?");
...
$sql = "SELECT b.venueid, v.vname, b.edate, b.start, b.end, b.requestedby, b.department, b.inchargeApproval 
        ...
        WHERE b.inchargeApproval='pending'";
